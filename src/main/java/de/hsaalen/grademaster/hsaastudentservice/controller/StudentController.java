...
public class StudentController {
    ...
    private static final Map<String, Student> STUDENTS = Map.ofEntries(
            ...
            Map.entry("00187", new Student("00187", "Ruby Scott", "ruby.scott@example.com")),
            Map.entry("00188", new Student("00188", "Ethan Williams", "ethan.williams@example.com")),
            Map.entry("00189", new Student("00189", "Layla Martinez", "layla.martinez@example.com")),
            Map.entry("00190", new Student("00190", "Jackson Rivera", "jackson.rivera@example.com")),
            Map.entry("00191", new Student("00191", "Lillian Brooks", "lillian.brooks@example.com")),
            Map.entry("00192", new Student("00192", "Samuel King", "samuel.king@example.com")),
            Map.entry("00193", new Student("00193", "Nora Price", "nora.price@example.com")),
            Map.entry("00194", new Student("00194", "Austin Bennett", "austin.bennett@example.com")),
            Map.entry("00195", new Student("00195", "Hazel Ward", "hazel.ward@example.com")),
            Map.entry("00196", new Student("00196", "Oliver Murphy", "oliver.murphy@example.com")),
            Map.entry("00197", new Student("00197", "Ellie Wood", "ellie.wood@example.com")),
            Map.entry("00198", new Student("00198", "Wyatt Gonzalez", "wyatt.gonzalez@example.com")),
            Map.entry("00199", new Student("00199", "Madeline Cooper", "madeline.cooper@example.com")),
